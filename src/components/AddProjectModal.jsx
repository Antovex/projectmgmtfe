...
export default function AddProjectModal() {
    ...
    // Reading the exsisting projects data from the cache and writing the new added project to cache also
    // after doing the mutation
    const [addProject] = useMutation(ADD_PROJECT, {
        ...
        update(cache, { data: { addProject }}) {
            ...
            cache.writeQuery({
                query: GET_PROJECTS,
                // using "spread" operator to spread current project and then add new project to cache
    ...
    // This function sets the data using useState
    const onSubmit = (e) => {
        e.preventDefault();
        ...
        // calling the function to add the new project data to DB
